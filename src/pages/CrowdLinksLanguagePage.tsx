...
import { Users, ArrowRight, CheckCircle, Globe as Globe2 } from 'lucide-react';
...
const LANGUAGE_DATA: Record<string, LanguageData> = {
  english: {
    ...
    heroDesc: 'Forum and community links placed on English-language platforms — the deepest inventory we cover, spanning US, UK, Canadian, and Australian communities.',
  ...
  spanish: {
    ...
    heroDesc: 'Forum and community links placed on Spanish-language platforms, covering both Spain and Latin American communities — a market most link building vendors don\u2019t serve natively.',
  ...
  german: {
    ...
    heroDesc: 'Forum and community links placed on German-language platforms across the DACH region — a smaller but notably high-quality, well-moderated market.',
  ...
  french: {
    ...
    heroDesc: 'Forum and community links placed on French-language platforms across France, Belgium, and Quebec.',
  ...
  portuguese: {
    ...
    heroDesc: 'Forum and community links placed on Brazilian Portuguese-language platforms — one of the fastest-growing, most digitally active markets we serve.',
  ...
  korean: {
    ...
    heroDesc: 'Community links placed within the Korean online ecosystem, including Naver Cafe communities — platforms most Western link building agencies don\u2019t operate in at all.',
...
const packages = [
  { name: 'Basic', links: '30 Links', domains: '30 unique domains', price: '$290', priceNote: '$9.67 per link', desc: 'Entry-level presence in this language market.', highlight: false, popular: false },
  { name: 'Standard', links: '60 Links', domains: '60 unique domains', price: '$520', priceNote: '$8.67 per link', desc: 'Consistent presence across primary communities in this market — most popular.', highlight: true, popular: true },
  { name: 'Powerful', links: '120 Links', domains: '120 unique domains', price: '$940', priceNote: '$7.83 per link', desc: 'High-volume coverage for competitive campaigns in this market.', highlight: false, popular: false },
];

const included = [
  'Native-language placement, not machine translation',
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-[1.08] tracking-tight mb-6">
              {data.label} Crowd Marketing<br />
              <span className="text-[#F97316]">Forum & Community Links</span>
            </h1>
      ...
      <section className="py-16 bg-gray-950">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-sm max-w-lg mx-auto">Same full-quality delivery process — choose by volume.</p>
          </div>
      ...
      <section className="py-14 bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-6 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-sm text-gray-500">
            ...
            Part of our full <Link to="/services/crowd-links" className="text-[#F97316] font-semibold hover:underline">Crowd Marketing service</Link>
          </div>
          <div className="flex flex-wrap gap-2">
            {Object.entries(LANGUAGE_DATA).filter(([code]) => code !== language).map(([code, d]) => (
              <Link key={code} to={`/services/crowd-links/${code}`} className="text-xs border border-gray-200 rounded-full px-3 py-1.5 text-gray-600 hover:border-[#F97316] hover:text-[#F97316] transition-colors">
                {d.label}
              </Link>
            ))}
          </div>
