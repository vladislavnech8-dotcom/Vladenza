...
const services: ServicePricing[] = [
  ...
  },
  {
    ...
    tiers: [
      { label: 'Starter', price: 'From $100', desc: 'DR 30–50 placements with 800+ word articles.', features: ['Niche-relevant domain', 'Manual QC check', '800+ word article', 'Permanent placement', 'Report with live URL'], highlight: false },
...
const pricingUk: Record<string, string> = {
  ...
  'From $500': 'Від $500', 'From $1,200': 'Від $1 200', 'From $100': 'Від $100', 'From $80': 'Від $80', 'From $180': 'Від $180', 'From $380': 'Від $380', 'From $1,500': 'Від $1 500', 'From $3,500': 'Від $3 500', 'From $600': 'Від $600', 'From $900': 'Від $900', 'From $700': 'Від $700', 'From $1K': 'Від $1K', 'From $3K': 'Від $3K', Custom: 'Індивідуально',
