      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white leading-[1.1] tracking-tight">{title}</h2>
            <p className="text-gray-500 mt-4 text-[15px] max-w-md leading-relaxed">{subtitle}</p>
          </div>
          <a
